...
const styles = StyleSheet.create({
    ...
    triggerButton: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: SurfaceColors.panelGlassStrong,
        borderWidth: 1,
    ...
    triggerSubtext: { color: TextColors.subTextMuted, fontSize: TypographyScale.micro, marginTop: 2 },
    triggerArrow: { color: DrawerTheme.goldBright, fontSize: 20, opacity: 0.6 },
    panel: {
        backgroundColor: SurfaceColors.blackOverlaySoft,
        borderWidth: 1,
        borderColor: SurfaceColors.panelBorderSoft,
        borderRadius: 12,
        overflow: 'hidden',
    },
    panelHeader: {
        ...
        paddingVertical: 10,
        borderBottomWidth: 1,
        borderBottomColor: SurfaceColors.panelBorderSubtle,
        backgroundColor: SurfaceColors.panelGlass,
    },
    panelTitle: {
    ...
    loadingText: { color: TextColors.subTextStrong, fontSize: TypographyScale.compact },
    errorArea: { padding: 16, gap: 10 },
    errorText: { color: TextColors.dangerSoft, fontSize: TypographyScale.compact },
    retryButton: {
        alignSelf: 'flex-start',
        paddingHorizontal: 12,
        paddingVertical: 6,
        borderRadius: 8,
        backgroundColor: SurfaceColors.chipBackground,
    },
    retryText: { color: DrawerTheme.goldBright, fontSize: TypographyScale.caption },
    ...
    moodText: { fontSize: TypographyScale.caption, fontWeight: '700' },
    section: { gap: 6 },
    sectionLabel: {
    ...
    sectionContent: { color: TextColors.subTextHigh, fontSize: TypographyScale.body, lineHeight: 21 },
    ...
    keywordChip: {
        ...
        backgroundColor: SurfaceColors.chipBackground,
        borderWidth: 1,
        borderColor: SurfaceColors.chipBorder,
    },
    keywordText: { color: TextColors.subTextStrong, fontSize: TypographyScale.caption },
    patternItem: { flexDirection: 'row', gap: 6 },
    patternDot: { color: DrawerTheme.goldBright, fontSize: 14 },
    patternText: { flex: 1, color: TextColors.subTextHigh, fontSize: TypographyScale.body, lineHeight: 20 },
    growthSection: {
        backgroundColor: SurfaceColors.successTintBg,
        borderRadius: 8,
        padding: 10,
        borderWidth: 1,
        borderColor: SurfaceColors.successTintBorder,
    },
    growthText: { color: TextColors.subTextHigh, fontSize: TypographyScale.body, lineHeight: 20 },
    adviceSection: {
        backgroundColor: SurfaceColors.warningTintBg,
        borderRadius: 8,
        padding: 10,
        borderWidth: 1,
        borderColor: SurfaceColors.warningTintBorder,
    },
    adviceText: { color: TextColors.subTextHigh, fontSize: TypographyScale.body, lineHeight: 20 },
});
